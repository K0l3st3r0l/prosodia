# Claude Code Guidelines — prosodia
...
2. Revisar `/root/apps/wiki/projects/prosodia/overview.md` si existe.

Conocimiento acumulado de este proyecto en `/root/apps/wiki/projects/prosodia/`.
